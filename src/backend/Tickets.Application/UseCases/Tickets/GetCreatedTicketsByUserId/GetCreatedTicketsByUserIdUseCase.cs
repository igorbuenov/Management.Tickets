...
{
    public class GetCreatedTicketsByUserIdUseCase : IGetCreatedTicketsByUserIdUseCase
    {
        private readonly ITicketRepository _ticketRepository;
        private readonly ICurrentUser _currentUser;

        public GetCreatedTicketsByUserIdUseCase(ITicketRepository ticketRepository, ICurrentUser currentUser)
        {
           ...
           int? status = null)
        {
            ...
            var tickets = await _ticketRepository.GetPagedByCreatedUser(
                userId,
                page,
                pageSize,
                title,
            ...
            var totalTickets = await _ticketRepository.CountByCreatedUser(
                userId,
                title,
                priority,
                status);
